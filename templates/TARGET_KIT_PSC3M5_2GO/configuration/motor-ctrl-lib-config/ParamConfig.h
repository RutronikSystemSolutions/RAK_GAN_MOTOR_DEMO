...
#define ADC_CS_SHUNT_RES                         (1.00f)                    /*[Ohm], Applicable for Current shunt type of measurement*/
#define ADC_CS_CURRENT_SENSITIVITY               (10.0E-3f)                    /*[V/A], Applicable for active current sense type of measurement*/

#define ADC_CS_OPAMP_GAIN                        (10.0f)                       /*[V/V], external amplifier gain for current measurement*/
...
/*********Rate Limiters*********/
#define MOTOR_CTRL_SPEED_CMD_RATE                  (2048.0f)                    /*[RPM/sec], Speed command rate*/
#define MOTOR_CTRL_SPEED_CMD_RATE_OPEN_LOOP        (2048.0f)                    /*[RPM/sec], Speed command rate during open loop state (Voltage OL and current OL)*/
...
#endif
/*********Faults*********/
#define MOTOR_CTRL_OVER_CURRENT_THRESH             (150.0f)                     /*[%], over current fault threshold, percentage of motor continuous current*/
...
/*********SPEED Controller*********/
#define MOTOR_CTRL_SPEED_BW                        (10.0f)                      /*[Hz], Speed loop bandwidth*/ //(15.0f)
#define MOTOR_CTRL_SPEED_OL_CL_TR_COEFF            (25.0f)                      /*[%], Open-loop to closed-loop transition coefficient*/
#define MOTOR_CTRL_SPEED_KI_MULTIPLE               (10.0f)                      /*[], Ki multiple for speed looop*/
#define MOTOR_CTRL_SPEED_FF_COEFF                  (60.0f)                        /*[%], Speed loop feed-forward coefficient*/ 
...
#if defined(CTRL_METHOD_RFO) || defined(CTRL_METHOD_TBC)
/*********Current Controller*********/
#define MOTOR_CTRL_CURRENT_BW                      (500.0f)                      /*[Hz], Current loop bandwidth*/
...
#define MOTOR_CTRL_VOLT_VF_OFFSET                  (0.70f)                       /*[V], V/F ramp voltage offset*/
#define MOTOR_CTRL_VOLT_VF_RATIO                   (6.5E-4f)                     /*[V/(Rad/secz], V/f ramp slope*/
...
/*******************************************************************************/
/*******DC Supply*******/
#define MOTOR_CTRL_VDC_NOM_VOLT                    (5.0f)                       /*[V], Nominal DC bus voltage*/

/*******************************************************************************/
/*******Motor*******/
#define MOTOR_POLE                                 (8.0f)                       /*[],  motor poles*/
#define MOTOR_LQ                                   (580.0E-6f)                  /*[H], Stator q-axis inductance*/
#define MOTOR_LD                                   (580.0E-6f)                  /*[H], Stator d-axis inductance*/
#define MOTOR_I_AM                                 (6.0E-4f)                    /*[Wb],  Rotor flux linkage*/
#define MOTOR_R                                    (6.2f)                       /*{Ohm],  stator resistance*/
#define MOTOR_TORQUE_MAX                           (0.0390f)                     /*[Nm],  maximum torque*/
#define MOTOR_CURRENT_PEAK                         (0.16f)                       /*[A],  peak current rating*/
#define MOTOR_CURRENT_CONT                         (0.15f)                       /*[A],  continuous current rating*/
#define MOTOR_ID_MAX                               (0.075f)                      /*[A], maximum d-axis current*/
#define MOTOR_VOLTAGE                              (5.0f)                      /*[V], motor voltage*/
#define MOTOR_NORM_SPEED                           (8192.0f)                    /*[RPM], nominal speed*/
#define MOTOR_MAX_SPEED                            (8192.0f)                    /*[RPM],  maximum no load speed*/
...
/*******Mechanical Load*******/
#define MECH_INERTIA                              (5.5E-8f)                    /*[kg.m^2],  Inertia*/
#define MECH_VISCOUS                              (6.0E-8f)                    /*[kg.m^2/sec], Viscous Damping*/
#define MECH_FRICTION                             (5.0E-5f)                    /*[kg.m^2/sec^2], Frittion*/
