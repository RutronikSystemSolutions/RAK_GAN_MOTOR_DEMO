...
static void* const ADC_Result_Regs_MUXA[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_RESULT_ADDR(0), ADC_RESULT_ADDR(2), ADC_RESULT_ADDR(8), ADC_RESULT_ADDR(10), ADC_RESULT_ADDR(12)},
         {ADC_RESULT_ADDR(1), ADC_RESULT_ADDR(4), ADC_RESULT_ADDR(9), ADC_RESULT_ADDR(11), ADC_RESULT_ADDR(3)}};
...
static void* const ADC_Result_Regs_MUXB[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_RESULT_ADDR(2), ADC_RESULT_ADDR(4), ADC_RESULT_ADDR(9),  ADC_RESULT_ADDR(11), ADC_RESULT_ADDR(12)},
         {ADC_RESULT_ADDR(2), ADC_RESULT_ADDR(8), ADC_RESULT_ADDR(10), ADC_RESULT_ADDR(11), ADC_RESULT_ADDR(3)}};
